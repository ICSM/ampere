...
class ASimpleModel(Model):
    ...
    def prior_transform(self, u, **kwargs):
        ...
        Prior transforms are essential for nested sampling. This is because most nested-sampling
        codes need to sample from the prior volume to correctly estimate the evidence (since it
        is the expectation of the likelihood).
        """
        if self.flatprior:
...
if __name__ == "__main__":
    ...
    with open("test_pickle_dynesty.pkl", "wb") as f:
        pickle.dump(optimizer, f)

    # Now try reading it back in:
    with open("test_pickle_dynesty.pkl", "rb") as f2:
        opt2 = pickle.load(f2)
