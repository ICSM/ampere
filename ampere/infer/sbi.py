...
class LFIBase(BaseSearch, Logger):
    ...
    Style to give to the name of the Inference object. Options are "full", "short", "stamp", and "model". Default is "full".
...
The number of rounds of sampling to do.
**kwargs : optional
...
"""
    ...
    def postProcess(self, show=False, textfile=None, **kwargs):
        ...
        **kwargs : additional keyword arguments
        Additional arguments to pass to the print_summary, plot_corner, and plot_posteriorpredictive functions.
