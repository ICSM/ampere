...
**2026-09-08 midday: W2.7, W2.9, W2.14 and W2.8 are ALL MERGED** (`f57c72f`, `c5b4915`, `4bf1164`, `71b2e96`; status rows). In flight: nothing until W2.11 is dispatched. Master gates: dev 1542/71; jax and torch re-run at the W2.8 merge (see the status commit). Nothing pushed.
