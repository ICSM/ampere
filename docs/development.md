...
## ⚡ Pick up here — Phase 3 APPROVED 2026-09-08 (W3.0–W3.10); W3.0 and W3.9 in flight; W3.1 slice 1 held for Peter's look
...
1. **Nod (or amend) the revised W3.1 slice 1 text** so it can be dispatched.
2. **W2.9's open question**, missed by the digest: a repeated-trial coverage study demonstrating the low-count profile bias in the WStat example (out of scope there; W2.10-adjacent). Schedule, defer or drop.
