...
Traceback (most recent call last):
    ...
ampere.core.exceptions.LikelihoodError: the rice family is declared but not implemented, and unlike a family staged for a specific phase, it has no scheduled one. ...
