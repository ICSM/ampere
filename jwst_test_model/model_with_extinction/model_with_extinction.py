...
class Extinctio_dust(Model):
    '''This is a extinction model based on the very simple model from Peter 

    It needs an update from the BlackBody model still, before updating the model with starfish, we will implement the fitzgerald code first. The parameter Rv will be set to 3.1. 
    ...
    def __init__(self, wavelengths, flatprior=True,
        ...
        opacityDirectory = os.path.dirname(os.path.realpath('__file__'))+'/dust_qext/'
