...
| W1.11 (a, b, d, e) | merged 2026-09-02 (Sonnet-authored, Fable-reviewed; every gap claim reproduced by execution during review; one fix on the branch — the proposed `Axis.locate` must match within `COORDINATE_RTOL`, not exactly). Five gaps recorded as proposed amendments, all routed to W1.7/W1.13; sketches (c), (f) + awkward-instrument stress test in flight separately |
| W1.7, W1.8, W1.10, W1.11 (c, f + stress test), W1.13 | in flight (W1.7, W1.11 remainder) / not started (W1.8, W1.10, W1.13) |
